...
public class Box <T extends Fruit> {
    private ArrayList<T> arrBox;

    public Box(ArrayList<T> arrBox) {
        this.arrBox = arrBox;
    }
    ...
    public boolean compare(Box <?> box) {
        if (this.getWeightBox().floatValue() == box.getWeightBox().floatValue()) return  true;
        return false;
    }

    public void overflowBox (Box <T> box) {
        System.out.println("В первом ящике = " + this.getWeightBox());
        System.out.println("Во втором ящике = " + box.getWeightBox());
        for(T t:box.getBox()){
            this.getBox().add(t);
        }
        box.getBox().clear();
        System.out.println("Стало в первом ящике = " + this.getWeightBox());
        System.out.println("Стало во втором ящике  = " + box.getWeightBox());
    }
}
